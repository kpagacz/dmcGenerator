...
export default function GermanVisa() {
  ...
  const handleFeatureTagChange = (index: number) => {
    return (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const changedFeature = newDocumentFeatures.find(
        (feature) => feature.id === index
      );
      if (changedFeature) {
        changedFeature.feature.tag = Number(value);
  ...
  const handleFeatureLengthChange = (index: number) => {
    return (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (changedFeature) {
        changedFeature.feature.length = Number(value);
        setDocumentFeatures(newDocumentFeatures);
      }
    };
  }
  ...
  const handleFeatureValueChange = (index: number) => {
    return (event: React.ChangeEvent<HTMLInputElement>) => {
      ...
      if (changedFeature) {
        changedFeature.feature.value = value;
        setDocumentFeatures(newDocumentFeatures);
      }
    };
  }
        ...
        <>
          <div className="items-center">
            {documentFeatures.map((feature) => {
              ...
              return (
                <div key={index}>Document Feature
                  <input
                    type="text"
                    name="tag"
                   placeholder="tag"
